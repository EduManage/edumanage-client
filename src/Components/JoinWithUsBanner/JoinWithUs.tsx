...
const JoinWithUs = () => {
    return (
        <div className='text-center p-6 w-full  font-poppins-em flex flex-col justify-center items-center'>
            ...
            <div className=' md:w-4/6'>
                ...
                <div className='pt-16'>
                    ...
                    <p className=' mb-20 md:max-w-3xl text-sm'>Join our community of learners and unlock your full potential. With expert guidance, cutting-edge resources, and a diverse group of peers, you'll gain the skills, knowledge, and confidence to excel in your studies.</p>
                </div>
