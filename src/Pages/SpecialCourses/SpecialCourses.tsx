...
import { AiFillPlayCircle, AiOutlineArrowDown, AiOutlineArrowUp, AiOutlineDown } from 'react-icons/ai'
import { BiBookContent } from 'react-icons/bi'
import { BsCheckLg, BsFillFileSpreadsheetFill, BsFillPeopleFill } from 'react-icons/bs'
                ...
                <div className='w-7/12'>
                    ...
                    <div className="mt-1 border-2 rounded-md flex gap-5 flex-wrap p-8 text-gray-500 text-sm">
                        ...
                        <div className='flex justify-center items-start gap-2'>
                            <BsCheckLg className='text-green-500' />
                            <p className=''>Access to relevant research articles and  resources</p>
                        </div>
                        <div className='flex justify-between items-start gap-2'>
                            <BsCheckLg className='text-green-500' />
                            <p className=''>Experienced instructors with a background  in the field</p>
                        </div>
                        <div className='flex justify-between items-start gap-2'>
                            <BsCheckLg className='text-green-500' />
                        ...
                        <div className='flex justify-between items-start gap-2'>
                            <BsCheckLg className='text-green-500' />
                            <p className=''>Opportunities for individualized feedback and support</p>
                        </div>
                    </div>
                    ...
                    <div className=' border-2 rounded-md p-8 relative'>
                        ...
                        <div className='absolute -bottom-13 left-0 right-0 flex flex-col justify-center items-center'>
                            <p onClick={handleLoadAll} className='cursor-pointer text-center btn btn-sm '>
                                {
                    ...
                    <h2 className="text-2xl mt-10 font-semibold  mb-2">See what others say</h2>
